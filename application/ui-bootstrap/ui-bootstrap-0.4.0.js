...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: 'application/ui-bootstrap/accordion/accordion.html'
  };
})
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: 'application/ui-bootstrap/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '=',
      noPause: '='
...
.directive('slide', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: 'application/ui-bootstrap/carousel/slide.html',
    scope: {
    },
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', function (dateFilter, $parse, datepickerConfig) {
  return {
    ...
    templateUrl: 'application/ui-bootstrap/datepicker/datepicker.html',
    link: function(scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: 'application/ui-bootstrap/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
...
.directive('pagination', ['paginationConfig', function(paginationConfig) {
  return {
    ...
    templateUrl: 'application/ui-bootstrap/pagination/pagination.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive('pager', ['pagerConfig', function(config) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: 'application/ui-bootstrap/pagination/pager.html',
    replace: true,
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: 'application/ui-bootstrap/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: 'application/ui-bootstrap/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: 'application/ui-bootstrap/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: 'application/ui-bootstrap/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: 'application/ui-bootstrap/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function(ratingConfig, $parse) {
  return {
    ...
    templateUrl: 'application/ui-bootstrap/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: 'application/ui-bootstrap/tabs/tabset.html',
    link: function(scope, element, attrs) {
...
function($parse, $http, $templateCache, $compile) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: 'application/ui-bootstrap/tabs/tab.html',
    transclude: true,
    scope: {
      heading: '@',
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
  return {
    ...
    require:'ngModel',
    replace: true,
    templateUrl: 'application/ui-bootstrap/timepicker/timepicker.html',
    scope: {
        model: '=ngModel'
    },
    link: function(scope, element, attrs, ngModelCtrl) {
